...

{
...

    {
        ...
        $this->defaults = array(
            ...
            'custom_amount_pln' => 450,

            'custom_amount_usd' => 100,

            'custom_amount_eur' => 100,

            'rule_a_amount_pln' => 299,

            'rule_a_amount_eur' => 59,

            'rule_a_amount_usd' => 149,

            'rule_b_amount_pln' => 399,

            'rule_b_amount_eur' => 159,

            'rule_b_amount_usd' => 149,
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'label' => $this->l('Custom free shipping amount (PLN)'),

                        'name' => 'custom_amount_pln',

                        'desc' => $this->l('Amount used when current storefront currency is PLN.'),
                    ...
                    array(
                        ...
                        'label' => $this->l('Custom free shipping amount (USD)'),

                        'name' => 'custom_amount_usd',

                        'desc' => $this->l('Amount used when current storefront currency is USD.'),
                    ...
                    array(
                        ...
                        'label' => $this->l('Custom free shipping amount (EUR)'),

                        'name' => 'custom_amount_eur',

                        'desc' => $this->l('Amount used when current storefront currency is EUR.'),
                    ...
                    array(
                        ...
                        'label' => $this->l('Rule A amount (PLN)'),

                        'name' => 'rule_a_amount_pln',

                        'desc' => $this->l('Default zone threshold in PLN.'),
                    ...
                    array(
                        ...
                        'label' => $this->l('Rule A amount (EUR)'),

                        'name' => 'rule_a_amount_eur',

                        'desc' => $this->l('Default zone threshold in EUR.'),
                    ...
                    array(
                        ...
                        'label' => $this->l('Rule A amount (USD)'),

                        'name' => 'rule_a_amount_usd',

                        'desc' => $this->l('Default zone threshold in USD.'),
                    ...
                    array(
                        ...
                        'label' => $this->l('Rule B amount (PLN)'),

                        'name' => 'rule_b_amount_pln',

                        'desc' => $this->l('Threshold for North America (id 6) and Central America (id 2) in PLN.'),
                    ...
                    array(
                        ...
                        'label' => $this->l('Rule B amount (EUR)'),

                        'name' => 'rule_b_amount_eur',

                        'desc' => $this->l('Threshold for North America (id 6) and Central America (id 2) in EUR.'),
                    ...
                    array(
                        ...
                        'label' => $this->l('Rule B amount (USD)'),

                        'name' => 'rule_b_amount_usd',

                        'desc' => $this->l('Threshold for North America (id 6) and Central America (id 2) in USD.'),
...

    {
        ...
        $free_ship_from = $this->getFreeShippingFromAmount();
    ...
    protected function getFreeShippingFromAmount()

    {
        ...
        $currencyIso = Tools::strtoupper((string) Context::getContext()->currency->iso_code);

        $zoneId = (int) $this->getCartZoneId();

        $isRuleBZone = in_array($zoneId, array(2, 6));

        $rulePrefix = $isRuleBZone ? 'rule_b_amount_' : 'rule_a_amount_';

        $amountByCurrency = array(

            'PLN' => (float) Configuration::get($this->cfgName . $rulePrefix . 'pln'),

            'USD' => (float) Configuration::get($this->cfgName . $rulePrefix . 'usd'),

            'EUR' => (float) Configuration::get($this->cfgName . $rulePrefix . 'eur'),

        );

        if (isset($amountByCurrency[$currencyIso])) {

            return $amountByCurrency[$currencyIso];
    ...
    protected function getCartZoneId()
