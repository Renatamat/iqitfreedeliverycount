...

{
...

    {
        ...
        $amountByCurrency = array(
            ...
            'PLN' => (float) Configuration::get($this->cfgName . 'custom_amount_pln'),

            'USD' => (float) Configuration::get($this->cfgName . 'custom_amount_usd'),

            'EUR' => (float) Configuration::get($this->cfgName . 'custom_amount_eur'),
